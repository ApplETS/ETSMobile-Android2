...
public class MenuAdapter$ViewHolder$$ViewInjector {
  public static void inject(Finder finder, final ca.etsmtl.applets.etsmobile.ui.adapter.MenuAdapter.ViewHolder target, Object source) {
    View view;
    view = finder.findById(source, 2131034129);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131034129' for field 'title' was not found. If this view is optional add '@Optional' annotation.");
    }
