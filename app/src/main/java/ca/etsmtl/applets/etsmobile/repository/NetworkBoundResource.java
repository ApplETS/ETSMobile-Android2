...
public abstract class NetworkBoundResource<ResultType, RequestType> {
    ...
    private final MediatorLiveData<RemoteResource<ResultType>> result = new MediatorLiveData<>();
    ...
    private void fetchFromNetwork(final LiveData<ResultType> dbSource) {
        ...
        result.addSource(dbSource,
                newData -> result.setValue(RemoteResource.loading(newData)));
            ...
            if (response.isSuccessful()) {
                ...
                result.addSource(dbSource,
                        newData -> result.setValue(
                                RemoteResource.error(response.errorMessage, newData)));
            }
        });
    }
    ...
    public LiveData<RemoteResource<ResultType>> asLiveData() {
        return result;
    }
